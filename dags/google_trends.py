...
## Load credentials
USER = "tom" #Variable.get("GT_USER")
PASSWORD = "google_trends_123" #Variable.get("GT_PASSWORD")
ENDPOINT = "datalakegt.cettyoj69g9b.us-east-1.rds.amazonaws.com" #Variable.get("GT_ENDPOINT")
PORT = 5432 #Variable.get("GT_PORT")
DATABASENAME = "datalakeGT" #Variable.get("GT_DATABASENAME")
